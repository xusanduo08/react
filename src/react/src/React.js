...
const createElement = true ? createElementWithValidation : createElementProd;
const cloneElement = true ? cloneElementWithValidation : cloneElementProd;
const createFactory = true ? createFactoryWithValidation : createFactoryProd;

const jsxDEV = true ? jsxWithValidation : undefined;
const jsx = true ? jsxWithValidationDynamic : jsxProd;
// we may want to special case jsxs internally to take advantage of static children.
// for now we can ship identical prod functions
const jsxs = true ? jsxWithValidationStatic : jsxProd;
