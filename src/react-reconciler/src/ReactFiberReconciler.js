...
import {getPublicInstance} from './forks/ReactFiberHostConfig.dom';
import {
...
export function injectIntoDevTools(devToolsConfig: DevToolsConfig): boolean {
  ...
  return injectInternals({
    ...
    // React Refresh
    findHostInstancesForRefresh: true ? findHostInstancesForRefresh : null,
    scheduleRefresh: true ? scheduleRefresh : null,
    scheduleRoot: true ? scheduleRoot : null,
    setRefreshHandler: true ? setRefreshHandler : null,
    // Enables DevTools to append owner stacks to error messages in DEV mode.
    getCurrentFiber: true ? () => ReactCurrentFiberCurrent : null,
  });
}
