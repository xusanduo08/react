      ...
      expect(tree).toEqual([
        {
          ...
          id: null,
          name: 'LabeledValue',
          value: true ? 'custom label a' : undefined,
          subHooks: [
            {
              isStateEditable: true,
              id: 0,
        ...
        },
        {
          ...
          id: null,
          name: 'LabeledValue',
          value: true ? 'custom label d' : undefined,
          subHooks: [
            {
              isStateEditable: true,
              id: 3,
      ...
      expect(tree).toEqual([
        {
          ...
          id: null,
          name: 'Outer',
          value: true ? 'outer' : undefined,
          subHooks: [
            {
              isStateEditable: false,
              id: null,
              name: 'Inner',
              value: true ? 'inner' : undefined,
              subHooks: [
                {
                  isStateEditable: true,
                  id: 0,
      ...
      expect(tree).toEqual([
        {
          ...
          value: true ? 'single one' : undefined,
          subHooks: [
            {
              isStateEditable: true,
              id: 0,
        ...
        },
        {
          ...
          value: true ? ['one', 'two', 'three'] : undefined,
          subHooks: [
            {
              isStateEditable: true,
              id: 1,
        ...
        },
        {
          ...
          id: null,
          name: 'SingleLabelCustom',
          value: true ? 'single two' : undefined,
          subHooks: [
            {
              isStateEditable: true,
              id: 2,
